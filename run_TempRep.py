...
from code.temporal_reproduction_task import TemRepSession
...
def main():
    ...
    # initialize
    session = TemRepSession(output_str, output_dir = output_dir, eyetracker_on=eyetracker_on,
                            n_trials=None, settings_file=settings)
    # create trials
